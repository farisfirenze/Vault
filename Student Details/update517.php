...
<h2 class="titl" style="top: 150px;left: 500px;">UPDATE FOR CS517</h2>
<div class="box">
...
if (mysqli_num_rows($result) > 0) 
{
    ...
    while($row = mysqli_fetch_assoc($result)) 
	{
				...
				if(isset($_POST['ct1_ct2'][$i])){
					...
					$query3 = "UPDATE CS517 SET CT1_CT2 = ".$_POST['ct1_ct2'][$i]." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query31 = "UPDATE CS517 SET TOTAL = ".$total." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query32 = "UPDATE CS517 SET GRADE = '".$grade."' WHERE ROLLNO = \"".$row['ROLLNO']."\";";
				...
				if(isset($_POST['internal'][$i])){
					...
					$query4 = "UPDATE CS517 SET INTERNAL = ".$_POST['internal'][$i]." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query31 = "UPDATE CS517 SET TOTAL = ".$total." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query32 = "UPDATE CS517 SET GRADE = '".$grade."' WHERE ROLLNO = \"".$row['ROLLNO']."\";";
				...
				if(isset($_POST['semester'][$i])){
					...
					$query5 = "UPDATE CS517 SET SEMESTER = ".$_POST['semester'][$i]." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query31 = "UPDATE CS517 SET TOTAL = ".$total." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query32 = "UPDATE CS517 SET GRADE = '".$grade."' WHERE ROLLNO = \"".$row['ROLLNO']."\";";
				...
				if(isset($_POST['grade'][$i])){
					$query7 = "UPDATE CS517 SET GRADE = '".$_POST['grade'][$i]."' WHERE ROLLNO = \"".$row['ROLLNO']."\";";
