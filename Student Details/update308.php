...
<h2 class="titl" style="top: 150px;left: 500px;">UPDATE FOR CS308</h2>
<div class="box">
...
$sql = "SELECT ROLLNO, NAME, CT1_CT2, INTERNAL, SEMESTER, TOTAL, GRADE FROM CS308";
...
if (mysqli_num_rows($result) > 0) 
{
    ...
    while($row = mysqli_fetch_assoc($result)) 
	{
				...
				if(isset($_POST['ct1_ct2'][$i])){
					...
					$query3 = "UPDATE CS308 SET CT1_CT2 = ".$_POST['ct1_ct2'][$i]." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query31 = "UPDATE CS308 SET TOTAL = ".$total." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query32 = "UPDATE CS308 SET GRADE = '".$grade."' WHERE ROLLNO = \"".$row['ROLLNO']."\";";
				...
				if(isset($_POST['internal'][$i])){
					...
					$query4 = "UPDATE CS308 SET INTERNAL = ".$_POST['internal'][$i]." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query31 = "UPDATE CS308 SET TOTAL = ".$total." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query32 = "UPDATE CS308 SET GRADE = '".$grade."' WHERE ROLLNO = \"".$row['ROLLNO']."\";";
				...
				if(isset($_POST['semester'][$i])){
					...
					$query5 = "UPDATE CS308 SET SEMESTER = ".$_POST['semester'][$i]." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query31 = "UPDATE CS308 SET TOTAL = ".$total." WHERE ROLLNO = \"".$row['ROLLNO']."\";";
					$query32 = "UPDATE CS308 SET GRADE = '".$grade."' WHERE ROLLNO = \"".$row['ROLLNO']."\";";
				...
				if(isset($_POST['grade'][$i])){
					$query7 = "UPDATE CS308 SET GRADE = '".$_POST['grade'][$i]."' WHERE ROLLNO = \"".$row['ROLLNO']."\";";
