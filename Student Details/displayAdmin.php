...
<h2 class="titl" style="top: 150px;left: 500px;">REPORT GENERATION</h2>
<div class="box">
<form name = "form1" method ="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
<table border=1 style="border-style: solid;position: relative;left: 50px;" width="1160">
<thead>
  <th>ROLLNO</th><th>NAME</th><th>CS302</th><th>CS304</th><th>CS306</th><th>CS308</th><th>CS314</th><th>CS316</th><th>CS517</th><th>HM104</th><th>HM302</th><th>CGPA</th>
  </thead>
  <?php
...
if(mysqli_num_rows($result0) > 0)
{
	...
	while($row = mysqli_fetch_assoc($result0))
	{
		...
		echo "<td>".$row['name']."</td>";
		echo "<td>".$row['cs302']."</td>";
		echo "<td>".$row['cs304']."</td>";
		echo "<td>".$row['cs306']."</td>";
		echo "<td>".$row['cs308']."</td>";
		echo "<td>".$row['cs314']."</td>";
		echo "<td>".$row['cs316']."</td>";
		echo "<td>".$row['cs517']."</td>";
		echo "<td>".$row['hm104']."</td>";
		echo "<td>".$row['hm302']."</td>";
		echo "</td><td>".$row['CGPA'];
		echo "</td></tr>";
	}
	echo "</tbody>";
...
/*$sql = "SELECT ROLLNO, NAME, CT1_CT2, INTERNAL, SEMESTER, TOTAL, GRADE FROM CS517";
